...
public class ShortUrl {
    ...
    private com.surya.urlshortener.domain.entities.User createdBy;
    ...
    public com.surya.urlshortener.domain.entities.User getCreatedBy() {
        return createdBy;
    }

    public void setCreatedBy(com.surya.urlshortener.domain.entities.User createdBy) {
